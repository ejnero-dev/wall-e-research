...
class AutoDetectionTester:
    ...
    async def run_all_tests(self):
        ...
        tests = [
            ...
            ("Detection Manager Initialization", self.test_detection_manager_initialization),
    ...
    async def test_scanner_initialization(self) -> bool:
        ...
        try:
            ...
            expected_fields = ["status", "is_running", "scan_interval_seconds", "known_products_count"]
    ...
    async def test_manual_scan(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.info(f"Manual scan failed (expected without authentication): {e}")
    ...
    async def test_product_detection_logic(self) -> bool:
        ...
        try:
            ...
            product1 = DetectedProduct(
                ...
                location="Madrid",
                status=DetectedProduct.__annotations__['status'].__args__[0].ACTIVE,  # ProductStatus.ACTIVE
