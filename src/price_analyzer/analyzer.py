...
class PriceAnalyzer:
    ...
    async def analyze_product_price(
        ...
        analysis = self._analyze_price_data(
            all_prices, amazon_prices, product_condition, include_shipping
        )
    ...
    def _filter_by_condition(
        self, prices: List[PriceData], target_condition: str
    ) -> List[PriceData]:
    ...
    def _calculate_confidence_score(
        self, num_samples: int, num_amazon: int, std_deviation: float
    ) -> float:
